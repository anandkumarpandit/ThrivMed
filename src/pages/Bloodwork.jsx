...
"
          >
            ...
            <div
              ...
              className="flex-none w-auto sm:w-40 md:w-52 h-12 md:h-16 px-6 sm:px-4 md:px-6 py-2.5 md:py-3.5 bg-[#267DFF] hover:bg-[#1a5bcc] cursor-pointer transition-all rounded-[80px] flex justify-center items-center"
            >
              <div
                data-layer="Buy Now"
        ...
        <div className="w-full pt-8 mb-16">
          <h2 className="lg:ml-64 flex lg:justify-end text-Primary-text dark:text-gray-100 text-4xl md:text-5xl font-light font-['DM_Sans'] mb-16 leading-[49.44px] lg:scale-75 lg:translate-y-6">
            How it reaches you
          </h2>
          ...
          <div className="flex flex-col gap-10 lg:gap-16">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16 w-full ">
              ...
              >
                <div
                  ...
                  className="self-stretch justify-start text-Primary-text dark:text-gray-100 text-2xl font-light font-['DM_Sans'] leading-7"
                >
                ...
                <div
                  ...
                  className="self-stretch flex flex-wrap lg:flex-nowrap justify-start items-start gap-3.5"
                >
                  <div
                    data-layer="Frame 422"
                    className="px-7 py-4 bg-[#C6DDFF] dark:bg-[#267DFF]/20 rounded-[55px] flex justify-center items-center gap-2.5 overflow-hidden flex-shrink-0"
                  >
                    <div
            ...
            {/* Step 2 */}
            <div className="flex flex-col lg:flex-row items-start lg:-translate-y-57 gap-10 lg:gap-16 w-full">
              <div className="w-full lg:w-80 flex flex-col gap-4 lg:ml-5 lg:text-left lg:scale-85">
            ...
            {/* Step 3 */}
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16 w-full lg:-translate-y-81 ">
              <div className="w-full lg:w-80 flex flex-col gap-4 lg:ml-5 lg:text-left lg:scale-85">
                <h3 className="text-Primary-text dark:text-gray-100 text-4xl lg:-translate-y-2 lg:translate-x-50 md:text-5xl font-light font-['DM_Sans']">
                  Step 3
                </h3>
              ...
              <div
                data-layer="Frame 427"
                className="flex-1 w-full min-h-[300px] lg:h-[453.99px] px-8 lg:pl-10 lg:pr-12 pt-10 pb-8 bg-zinc-100 dark:bg-[#151619] rounded-[20px] flex flex-col justify-between items-start transition-colors lg:scale-77 lg:-translate-y-20 lg:-translate-x-7"
              >
                <div
            ...
            {/* Step 4 */}
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16 w-full lg:-translate-y-124">
              <div className="w-full lg:w-80 flex flex-col gap-4 lg:ml-5 lg:text-left lg:scale-85">
                <h3 className="text-Primary-text dark:text-gray-100 text-4xl lg:-translate-y-2 lg:translate-x-50 md:text-5xl font-light font-['DM_Sans']">
                  Step 4
                </h3>
